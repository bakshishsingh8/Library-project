...
// import { BookOpen, Upload, IndianRupee, X, CheckCircle2, Sparkles } from "lucide-react";
...
//     // Limit to 4 images for a cleaner UI
//     const newImages = files.map((file) => URL.createObjectURL(file)).slice(0, 4);
...
//               <p className="text-sm text-gray-500">Your book is being reviewed.</p>
//             </div>
//           </motion.div>
//         )}
//       </AnimatePresence>
...
//         className="w-full max-w-4xl bg-white/80 backdrop-blur-xl border border-white/50 rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.1)] overflow-hidden flex flex-col md:flex-row"
//       >
...
//             <p className="mt-4 text-amber-50 opacity-90 leading-relaxed">
...
//               {[1, 2, 3, 4].map((i) => (
//                 <div key={i} className="w-10 h-10 rounded-full border-2 border-amber-500 bg-amber-200 overflow-hidden">
...
//               <div className="group">
//                 <label className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2 block ml-1">Book Title</label>
//                 <input
//                   type="text" name="title" placeholder="e.g. Harry Potter"
//                   value={form.title} onChange={handleChange}
//                   className="w-full px-5 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-amber-400 transition-all outline-none text-gray-700"
//                   required
//                 />
//               </div>
//               <div className="group">
//                 <label className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2 block ml-1">Author</label>
//                 <input
...
//             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//               <div>
//                 <label className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2 block ml-1">Price</label>
...
//                     className="w-full pl-12 pr-5 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-amber-400 transition-all outline-none text-gray-700"
//                     required
//                   />
//                 </div>
//               </div>
//               <div>
//                 <label className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2 block ml-1">Condition</label>
//                 <select
//                   name="condition" value={form.condition} onChange={handleChange}
//                   className="w-full px-5 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-amber-400 transition-all outline-none text-gray-700 appearance-none"
//                   required
//                 >
//                   <option value="">Select Condition</option>
//                   <option value="New">New (Unopened)</option>
//                   <option value="Good">Good (Lightly Used)</option>
//                   <option value="Used">Used (Readable)</option>
//                 </select>
//               </div>
//             </div>
...
//               <div className="border-2 border-dashed border-gray-200 group-hover:border-amber-400 rounded-3xl p-8 transition-all bg-gray-50/50">
//                 <input
...
//                   </p>
//                   <p className="text-xs text-gray-400">Up to 4 high-quality photos</p>
//                 </div>
//               </div>
...
//                         className="relative w-20 h-20 rounded-2xl overflow-hidden shadow-md border-2 border-white"
//                       >
//                         <img src={img} alt="preview" className="w-full h-full object-cover" />
//                         <button
//                           onClick={() => removeImage(index)}
//                           className="absolute top-1 right-1 p-1 bg-red-500/80 text-white rounded-full backdrop-blur-sm hover:bg-red-600 transition-colors"
//                         >
//                           <X className="w-3 h-3" />
//                         </button>
//                       </motion.div>
...
//             <div>
//               <label className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2 block ml-1">UPI ID for Payment</label>
//               <input
...
//             <button
//               type="submit"
//               className="w-full py-3 rounded-2xl bg-gray-900 text-white cursor-pointer font-bold text-lg shadow-xl hover:bg-amber-600 hover:shadow-amber-200 transition-all duration-300 flex items-center justify-center gap-3 active:scale-[0.98]"
//             >
