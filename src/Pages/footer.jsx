...
// function Footer() {
//     return (
//         <footer className="bg-gradient-to-t from-orange-200 via-amber-100 to-orange-200  py-10 rounded-2xl">
...
//                         Discover, explore, and enjoy a world full of stories and knowledge.
...
//                         <li><a href="/welcome" className="hover:text-orange-400">Home</a></li>
...
//                     <p className="flex items-center gap-2"><i className="fas fa-phone"></i> +91 98765 43210</p>
//                     <p className="flex items-center gap-2"><i className="fas fa-envelope"></i> info@bookhavenlibrary.com</p>
//                     <p className="flex items-center gap-2"><i className="fas fa-map-marker-alt"></i> New Delhi, India</p>
//                 </div>
...
//                         <a href="https://www.facebook.com/" className="hover:text-orange-400"><i className="fab fa-facebook-f"></i></a>
//                         <a href="https://www.instagram.com/" className="hover:text-orange-400"><i className="fab fa-instagram"></i></a>
//                         <a href="https://x.com/?lang=en" className="hover:text-orange-400"><i className="fab fa-twitter"></i></a>
//                         <a href="https://www.youtube.com" className="hover:text-orange-400"><i className="fab fa-youtube"></i></a>

//                          {/* <ul className="space-y-2">

//                             <li><a href="https://www.facebook.com/" className="hover:text-orange-400"><i className="fab fa-facebook-f"></i></a></li>
//                            <li><a href="https://www.instagram.com/" className="hover:text-orange-400"><i className="fab fa-instagram"></i></a></li>
//                             <li><a href="https://x.com/?lang=en" className="hover:text-orange-400"><i className="fab fa-twitter"></i></a></li>
//                             <li><a href="https://www.youtube.com" className="hover:text-orange-400"><i className="fab fa-youtube"></i></a></li>
//                         </ul> */}
//                     </div>
//                 </div>
//             </div>
